    ...
    public partial class Employee : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
            {
                ...
                x.sqlConnection1.Open();
                SqlCommand cx = new SqlCommand("insert into employee (Emp_Name,Sex,Emp_Salary,Emp_Qualification,Emp_contact) values(@Emp_Name,@Sex,@Emp_Salary,@Emp_Qualification,@Emp_Contact)", x.sqlConnection1);
                ...
                cx.Parameters.AddWithValue("@Emp_Contact", textBox6.Text);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    this.textBox6.Text = dr["Emp_Contact"].ToString();
                }
            }
            catch (Exception eee)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
            {
                ...
                x.sqlConnection1.Open();
                SqlCommand cmd = new SqlCommand("Update Employee set Emp_name=@Emp_name,Sex=@sex,Emp_Salary=@Emp_Salary,Emp_Qualification=@Emp_Qualification,Emp_Contact=@Emp_contact where Employee_id=@Employee_id", x.sqlConnection1);
                ...
                cmd.Parameters.AddWithValue("@Emp_Contact", textBox6.Text);
